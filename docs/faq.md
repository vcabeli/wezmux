...
issue](https://github.com/vcabeli/wezmux/issues) and include the `xxd` hexdump,
...
```bash
tempfile=$(mktemp) \
  && curl -o $tempfile https://raw.githubusercontent.com/vcabeli/wezmux/main/termwiz/data/wezterm.terminfo \
