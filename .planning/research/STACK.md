...
**Domain:** WezTerm fork — GPU-rendered sidebar UI and OSC notification system
**Researched:** 2026-03-24
**Confidence:** HIGH (primary sources: WezTerm source tree, workspace Cargo.toml, official docs)
...
These are modules already in the WezTerm codebase that the sidebar implementation must use directly. They are listed here because understanding their API is a prerequisite for correct implementation.
...
This is a fork, not a new project. There are no new packages to `npm install`. The workflow is:

```bash
# Fork setup
git clone https://github.com/wezterm/wezterm wezmux
cd wezmux
...
**Sidebar layout (static, no animation for v1):**
...
**Notification ring (pane border highlight):**
...
**Background polling (git branch, PR status, ports):**
...
**Workspace switch (sidebar click):**
...
---
*Stack research for: wezmux — WezTerm fork with sidebar and notifications*
*Researched: 2026-03-24*
