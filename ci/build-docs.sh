...
[[ -f /tmp/wezmux.releases.json ]] || ghapi /repos/vcabeli/wezmux/releases > /tmp/wezmux.releases.json
[[ -f /tmp/wezmux.nightly.json ]] || ghapi /repos/vcabeli/wezmux/releases/tags/nightly > /tmp/wezmux.nightly.json
