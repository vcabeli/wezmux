...
pub enum UIItemType {
    ...
    SidebarCloseWorkspace(String),
    SidebarNewWorkspace,
    SidebarNotificationBell,
    SidebarSplitHorizontal,
    SidebarSplitVertical,
    SidebarSettings,
    SidebarResizeHandle,
    SidebarBackground,
    AboveScrollThumb,
...
impl TermWindow {
    pub async fn new_window(mux_window_id: MuxWindowId) -> anyhow::Result<()> {
        ...
        let sidebar_width = sidebar::configured_pixel_width(&config, h_context);
...
impl TermWindow {
    ...
    fn update_title_impl(&mut self) {
        ...
        let tab_bar_hover_x = self.current_mouse_event.as_ref().map(|event| {
    ...
    pub fn perform_key_assignment(
        ...
        match assignment {
            ...
            PromptNewWorkspace => self.show_new_workspace_prompt(),
            ReloadConfiguration => config::reload(),
            ToggleSidebar => self.toggle_sidebar(),
            JumpToUnreadNotification => self.jump_to_unread_notification(),
