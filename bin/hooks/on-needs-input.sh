...
printf '\033]7777;status;needs_input\007' > "${WEZMUX_TTY:-/dev/tty}" 2>/dev/null || true
printf '\033]9;Claude is waiting for your input\007' > "${WEZMUX_TTY:-/dev/tty}" 2>/dev/null || true
exit 0
